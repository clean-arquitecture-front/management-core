...
var RestAxios = (function () {
    ...
    RestAxios.prototype.get = function (path, params) {
...
var validatorCustomer = {
    ...
    dni: { required: validators.required }
};
...
var GetCustomerUseCase = (function () {
    ...
    GetCustomerUseCase.prototype.getCustomer = function (id) {
        return this.restPort.get("/v1/customer/".concat(id), null);
    };
...
var ListCustomerUseCase = (function () {
    ...
    ListCustomerUseCase.prototype.listCustomer = function (params) {
...
var listCustomer = function (params) {
    var listCustomerPort = iListCustomerPort();
    return listCustomerPort.listCustomer(params);
};
...
exports.validatorCustomer = validatorCustomer;
